...
export default function Application(database)
{
	this.mr = this.router = new My_Router();
...
Application.prototype.move_tag = function ()
{
	...
	params.handler = function (value) {
		...
		self.dynalinks.move_tag(
			...
			new_category);
		//3. reshow page
		self.mr.navigate( self.dynalinks.create_url(new_category,tag), true);
...
Application.prototype.add_item = function ()
{
	...
	params.handler = function (value) {
		...
		self.mr.navigate(self.dynalinks.create_url(category, tag), true);
	}
...
Application.prototype.edit_item = function (id)
{
	...
	params.handler = function (value) 
	{
		...
		self.mr.navigate(self.dynalinks.create_url(result.category, result.tag), true);			
	}
	var form = new PopupForm(params);
	form.show();
...
Application.prototype.remove_category = function ()
{
	...
	params.handler = function (value) {
		...
		self.mr.navigate(self.dynalinks.create_url(get_first_key(self.dynalinks.names)), true);
	}
	var form = new PopupForm(params);
	form.show();
}
...
Application.prototype.remove_tag = function ()
{
	...
	params.handler = function (value) {
		...
		self.mr.navigate(self.dynalinks.create_url(self.dynalinks.context.category_name), true);
	}
	var form = new PopupForm(params);
	form.show();
}
...
Application.prototype.create_category = function ()
{
	...
	params.handler = function (value) {
		...
		self.mr.navigate(self.dynalinks.create_url(value), true);
	}
	var form = new PopupForm(params);
	form.show();
}
...
Application.prototype.search = function (text)
{
	...
	this.mr.navigate(create_url("search", value), true);
}
...
Application.prototype.init_router = function()
{
	...
	this.mr.add_route("view/:category/:page", 
	...
	this.mr.add_route("view/:category", function (category) {
		this.show_category(category);		
		this.show_page(null);
	}, this.dynalinks);
	
	this.mr.add_default(function () {
